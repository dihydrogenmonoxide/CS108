 ...
 * 
 */
public class Jet extends Unit implements GamePlayObject, InterAct {
	...
	public Jet(Coordinates pos, User owner) {
		this.position = pos;
	...
	public boolean isAttackableObject(GamePlayObject target) {
		...
		if ((target instanceof Bomber || target instanceof Jet)
