...
public class GamePlayObjectManager {
	...
	GamePlayObjectManager(){
		AllObjects = new LinkedList<GamePlayObject>();
		Defensives= new LinkedList<Defensive>();
	...
	/**
	 * Ad an Object of Type Defensive to the List of Defensive Objects and
	 * to the List of all GamePlayObjects in the List AllObjects.
	 * @param Defensive O
	 */
	...
	/**
	 * Ad an Object of Type Unit to the List of Unit Objects and
	 * to the List of all GamePlayObjects in the List AllObjects.
	 * @param Unit U
	 */
	...
	/**
	 * 
	 * Ad an Object of Type Building to the List of Building Objects and
	 * to the List of all GamePlayObjects in the List AllObjects.
	 * @param Building U
	 * 
	 */
	...
	/**
	 * The Function which calculates a Round:
	 * Fist
	 * Every Unit calculates its move
	 * 
	 * Every Unit sends to every Defensive it's Moving
	 * Every Defensive saves the Objects which move through its Range in a List of possible Targets
	 * 
	 * Every Unit Moves
	 * 
	 * Every Unit shoots its ammunation at a randomly chosen Target of the possibleTarget List
	 *
	 *A Helplist is generated
	 *
	 *Every Object which lives(HP>0) gets copied to the AllObjects List
	 *If an Object is dead, it gets removed from the Unit/Building/Defensive list
	 *
